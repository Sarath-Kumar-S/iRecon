...
cred_obj = firebase_admin.credentials.Certificate(r'GENERATED KEY.JSON FILE DOWNLOADED')
default_app = firebase_admin.initialize_app(cred_obj, {'databaseURL': 'YOUR CREATED DATABASE URL'})
ref = db.reference('/')
users_ref = ref.child('..') #if required
